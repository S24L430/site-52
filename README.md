...
## Environments
- Preview: https://main--site-52--s24l430.hlx.page/
- Live: https://main--site-52--s24l430.hlx.live/
- Custom Domain: https://site-52.impactful-3.site (Available during the lab)
...
WKND_URL=https://main--site-52--s24l430.hlx.live ITERATIONS=1000 npm run generate-traffic
```
